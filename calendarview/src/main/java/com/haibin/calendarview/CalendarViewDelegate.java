...
final class CalendarViewDelegate {
    ...
    CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        mMonthViewScrollable = array.getBoolean(R.styleable.CalendarView_month_view_scrollable, false);
        ...
        mCurDayTextColor = array.getColor(R.styleable.CalendarView_current_day_text_color, Color.BLACK);//Color.RED
        ...
        mCalendarItemHeight = (int) array.getDimension(R.styleable.CalendarView_calendar_height,
                CalendarUtil.dipToPx(context, 40));//56

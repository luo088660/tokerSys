...
abstract class BaseFragment<V : IBaseView, T : BasePresenter<V>>
    ...
    fun getItemDecoration(): RecyclerView.ItemDecoration {
        ...
        itemDecoration.setDrawable(ContextCompat.getDrawable(context!!, R.drawable.search_history_solid)!!)
    ...
    protected fun initSpringView(spView: SpringView) {
        ...
        spView.header = DefaultHeader(context)
        spView.footer = DefaultFooter(context)

...
object CommonUtils {
     ...
     * toast
     */
    fun toast(context: FragmentActivity?, text: CharSequence) {
        show(context, text)
    }

    fun show(context: FragmentActivity?, text: CharSequence) {
    ...
    fun createDialog(context: Context, view: View, theme: Int, vararg cancel: Boolean): Dialog {
        ...
        dialog.setCanceledOnTouchOutside(if (cancel.isNotEmpty()) cancel[0] else false)
        return dialog
    ...
    fun inflateView(context: Context, layoutId: Int, vararg root: ViewGroup): View {
        return LayoutInflater.from(context).inflate(layoutId, if (root.isNotEmpty()) root[0] else null, false)
    }

    /**
     * 加载 尺寸
     */
    fun getDimen_(context: FragmentActivity?, resId: Int): Float {
     ...
     * 加载 drawable
     */
    fun getDrawable_(context: FragmentActivity?, resId: Int): Drawable {
     ...
     * 加载 color
     */
    fun getColor_(context: FragmentActivity?, resId: Int): Int {

...
class GroupPjtAdapter(val mContext: Context, val data: MutableList<GroupProjectBean.Data>) :
    RecyclerView.Adapter<GroupPjtAdapter.PLViewHodler>() {
    ...
    public interface ProjecListListener {
        fun itemListener(bean: GroupProjectBean.Data)
    }

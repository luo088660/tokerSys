...
import com.toker.sys.dialog.adapter.ProjectCityAdapter
import com.toker.sys.view.home.activity.custom.bean.ProjectOnCityBean
import org.greenrobot.eventbus.EventBus

class ProjectCityDialog(
    private val mContext: Context, val mBeans: MutableList<ProjectOnCityBean.Data>
) : View.OnClickListener, ProjectCityAdapter.ProCityListener {
    private val Tag = "ProjectListDialog";
    var dialog: Dialog? = null

    override fun itemListener(bean: ProjectOnCityBean.Data) {
    ...
    init {
        ...
        val listAdapter = ProjectCityAdapter(mContext, mBeans)
